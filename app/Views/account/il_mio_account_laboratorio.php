        ...
        <div class="col-xl-8 order-xl-1 mb-5 mb-xl-0">
          <div class="card card-profile shadow">
            ...
            <div class="card-body pt-0 pt-md-4">
			  ...
			  <div style="text-align:right"><a href="/Account/modificaInfo/Laboratorio"><i class="fas fa-pen-alt"></i>    Modifica</a></div></br>
              ...
              <div class="text-center">
                ...
                <div class="h3 mt-0"></br>Nome Titolare</span></div></br>
				...
				<div class="modal-content">
					<form action="/Account/eliminaAccount/Laboratorio">
